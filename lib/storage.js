...
function bucket() {
  ...
  client ||= new Storage({ projectId: process.env.GOOGLE_CLOUD_PROJECT_ID || "your-google-cloud-project-id" });
  return client.bucket(process.env.GOOGLE_CLOUD_STORAGE_BUCKET || "your-storage-bucket");
}
